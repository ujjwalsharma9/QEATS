...
class RestaurantServiceTest {
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    // System.out.println(getServingRadius(loadRestaurantsDuringNormalHours(), LocalTime.of(0, 0)));

    assertEquals(getServingRadius(loadRestaurantsDuringNormalHours(), LocalTime.of(0, 0)), "5.0");
